...
#ifndef GPLX_VN_SWIFT_H
#define GPLX_VN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="gplx_vn",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC7gplx_vn11AppDelegate")
...
SWIFT_CLASS("_TtC7gplx_vn17MainFlutterWindow")
